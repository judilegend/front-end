<template>
  <main
    className="sidebar h-screen fixed  top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[300px] overflow-y-auto text-center bg-gray-900"
  >
    {/*
    ...
    */}
    <div class="text-gray-100 text-xl">
      <div class="p-2.5 mt-1 flex items-center">
        ...
        <h1 class="font-bold text-gray-200 text-[15px] ml-3">G-Mobile Money</h1>
    ...
    <section className="">
      <ul>
        ...
        <div
          className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white"
        >
          <!-- <img src="/icon/Initiate Money Transfer.svg" alt="" className="w-6" /> -->
          <span className="text-[15px] ml-4 text-gray-200 font-bold">
            Envoyer
          </span>
        </div>
